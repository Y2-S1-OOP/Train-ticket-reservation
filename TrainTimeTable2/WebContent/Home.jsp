...
<body
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('resources/home/images/adam-vandermeer-Dw9dWTzzsUE-unsplash.jpg')">
				...
				<div class="carousel-item"
					style="background-image: url('resources/home/images/minura-wijesena-ECWxeU9A7uY-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
				...
				<div class="carousel-item"
					style="background-image: url('resources/home/images/kevin-olson-0udyYWLlzu0-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
	...
	<section style="text-align: center;">
		...
		<button type="button" class="btn btn-primary btn-lg"
			style="background-color: #33ccff;">Time Table</button></a>
		<a href="SearchTrainBook.jsp">
			<button type="button" class="btn btn-primary btn-lg">Book
				your ticket</button>
		</a>
		<button type="button" class="btn btn-secondary btn-lg">Cancel
			your ticket</button>
	</section>
	<br>
	<br>
	...
	<div class="col-sm-5 col-md-5 col-xs-5"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding:15px;">
				<img alt="" src="resources/home/images/demodara_1.jpg"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding: 15px">
				<img alt="" src="resources/home/images/s13.jpg"
