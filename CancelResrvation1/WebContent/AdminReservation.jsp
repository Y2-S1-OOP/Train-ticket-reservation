	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			<div
				...
				<div class="navi">
					<ul>
						<li class="active"><a href="AdminDashboard.jsp"><i class="fa fa-home"
        ...
        <div class="col-md-8 mx-auto">
				<table border="1" class="table bg-white rounded border table-striped table-dark">
					...
					<tr>
						...
						<th scope="col">From Station</td>
						<th scope="col">To Station</td>
						<th scope="col">PaymentID</td>
						<th scope="col">Booked Date</td>
					...
					<tr style="background-color:#eee;">
						<td scope="row"><%=resultSet.getString("ReservationID")%></td>
						<td><%=resultSet.getString("Name")%></td>
						<td><%=resultSet.getString("FromStation")%></td>
						<td><%=resultSet.getString("ToStation")%></td>
		                <td><%=resultSet.getString("PaymentID")%></td>
						<td><%=resultSet.getString("BookedDate")%></td>
						
                     <td><a href="AdminReservationUpdate.jsp?ReservationID=<%=resultSet.getString("ReservationID")%>"><button>Update</button></a></td>
				     <td><a href="AdminReservationDelete.jsp?ReservationID=<%=resultSet.getString("ReservationID")%>"><button>Delete</button></a></td>
