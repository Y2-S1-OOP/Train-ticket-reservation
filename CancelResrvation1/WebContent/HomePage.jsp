...
<body
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('resources/Images/adam-vandermeer-Dw9dWTzzsUE-unsplash.jpg')">
				...
				<div class="carousel-item"
					style="background-image: url('resources/Images/minura-wijesena-ECWxeU9A7uY-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
				...
				<div class="carousel-item"
					style="background-image: url('resources/Images/kevin-olson-0udyYWLlzu0-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
	...
	<section style="text-align: center;">
		...
		<a href="CheckReservation.jsp">
		<button type="button" class="btn btn-secondary btn-lg">Cancel or Update
			your ticket</button>
		</a>	
  ...
  <div class="row">
	...
	<div class="col-sm-5 col-md-5 col-xs-5"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding-left:15px;">
				<img alt="" src="resources/Images/demodara_1.jpg"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding: 15px">
				<img alt="" src="resources/Images/s13.jpg"
