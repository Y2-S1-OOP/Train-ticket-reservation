    ...
    <div class="">
        <div class="row">
            <div class="col-md-offset-2 col-md-6">
                ...
                <form action="DeleteReservation" method="post" class="form-horizontal">
                <% 
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">   
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" id="exampleInputName2" name="name" value="<%=result.getString("Name")%>" type="text" readonly>
                            </div>
                         </div>
                         <div class="form-group">   
                            <div class="col-sm-6">
                                <label class="control-label">From Station</label><br>
                                <input class="form-control" id="exampleInputName2" name= "from" value="<%=result.getString("FromStation")%>" type="text" readonly>
                            </div>
                         </div>
                         <div class="form-group">   
                            <div class="col-sm-6">
                                <label class="control-label">To Station</label><br>
                                <input class="form-control" id="exampleInputName2" name="to" value="<%=result.getString("ToStation")%>" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label class="control-label">Payment ID</label><br>
                                <input class="form-control" id="exampleInputName2" name="paymentID" value="<%=result.getString("PaymentID")%>" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label class="control-label">Booked Date</label><br>
                                <input class="form-control" id="exampleInputName2" name="date" value="<%=result.getString("BookedDate")%>" type="text" readonly>
                            </div>
                   </div>
                    
                        <div class="clearfix">
                            <input type="submit" class="btn btn-default btnmk" name="delete" value="Delete">
                        </div>
