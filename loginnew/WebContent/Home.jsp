		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="login.jsp">Sign In</a>
					</li>
		...
		<div id="carouselExampleIndicators" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url('resourse/img/adam-vandermeer-Dw9dWTzzsUE-unsplash.jpg')">
				...
				<div class="carousel-item"
					style="background-image: url('resourse/img/minura-wijesena-ECWxeU9A7uY-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
				...
				<div class="carousel-item"
					style="background-image: url('resourse/img/kevin-olson-0udyYWLlzu0-unsplash.jpg')">
					<div class="carousel-caption d-none d-md-block">
	...
	<div class="col-sm-5 col-md-5 col-xs-5"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding:15px;">
				<img alt="" src="resourse/img/demodara_1.jpg"
		...
		<div>
			<div class="col-sm-4 col-md-4 col-xs-8" style="padding: 15px">
				<img alt="" src="resourse/img/s13.jpg"
